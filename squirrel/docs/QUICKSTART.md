# Quick Start Guide - Job Squirrel Integration

Get started with the integrated job squirrel in 5 minutes!
...
filtered = squirrel.filter_jobs(jobs)
...
matches = squirrel.match_resume_to_jobs(resume, filtered)
