# Job Squirrel Integration Architecture
...
│   ├── squirrels/
│   │   ├── __init__.py
│   │   ├── base_squirrel.py            [Base Class]
│   │   ├── jobs_squirrel.py            [Jobs Implementation] ★
│   │   └── foolsball_squirrel.py
│   │
│   └── utils/
│       ├── __init__.py
│       ├── cache.py                   [Caching]
